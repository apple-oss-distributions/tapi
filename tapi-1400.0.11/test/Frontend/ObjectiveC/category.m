...
// CHECK-NEXT:    USR: c:objc(cy)Foo@Bar
// CHECK-NEXT:    loc:
...
// CHECK-NEXT:      USR: c:objc(cs)Foo(im)method2
// CHECK-NEXT:      loc:
// CHECK-NEXT:      availability: i:0 d:0 o:0 u:0
...
// CHECK-NEXT:      USR: c:objc(cs)Foo(py)prop2
// CHECK-NEXT:      loc:
// CHECK-NEXT:      availability: i:0 d:0 o:0 u:0
...
// CHECK-NEXT:    interfaceName: Foo
// CHECK-NEXT:    USR: c:objc(cy)Foo@CoreDataGeneratedAccessors
// CHECK-NEXT:    loc:
// CHECK-NEXT:    availability: i:0 d:0 o:0 u:0
// CHECK-NEXT:    protocols:
// CHECK-NEXT:    methods:
...
// CHECK-NEXT:      USR: c:objc(cs)Foo(im)addChildObject
// CHECK-NEXT:      loc:
// CHECK-NEXT:      availability: i:0 d:0 o:0 u:0
...
// CHECK-NEXT:      isOptional: false
// CHECK-NEXT:      isDynamic: true
// CHECK-NEXT:      USR: c:objc(cs)Foo(im)removeChildObject
// CHECK-NEXT:      loc:
// CHECK-NEXT:      availability: i:0 d:0 o:0 u:0
...
// CHECK-NEXT:      isOptional: false
// CHECK-NEXT:      isDynamic: true
// CHECK-NEXT:      USR: c:objc(cs)Foo(im)addChild
// CHECK-NEXT:      loc:
// CHECK-NEXT:      availability: i:0 d:0 o:0 u:0
...
// CHECK-NEXT:      isOptional: false
// CHECK-NEXT:      isDynamic: true
// CHECK-NEXT:      USR: c:objc(cs)Foo(im)removeChild
// CHECK-NEXT:      loc:
// CHECK-NEXT:      availability: i:0 d:0 o:0 u:0
// CHECK-NEXT:    properties:
// CHECK-NEXT:    instance variables:
...
// CHECK-NEXT:     isOptional: false
// CHECK-NEXT:     isDynamic: false
// CHECK-NEXT:     USR: c:objc(cs)Foo(im)method3
// CHECK-NEXT:     loc:
// CHECK-NEXT:     availability: i:0 d:0 o:0 u:0
// CHECK-NEXT:   properties:
...
// CHECK-NEXT:     USR: c:objc(cs)Foo(py)prop3
// CHECK-NEXT:     loc:
// CHECK-NEXT:     availability: i:0 d:0 o:0 u:0
// CHECK-NEXT:   instance variables:
// CHECK-NEXT:   - name: ivar3
// CHECK-NEXT:     USR: c:objc(cs)Foo@ivar3
// CHECK-NEXT:     loc:

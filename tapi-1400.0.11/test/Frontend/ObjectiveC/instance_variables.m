...
// CHECK-NEXT:   USR: c:objc(cs)Forward
// CHECK-NEXT:   loc:
...
// CHECK-NEXT:     USR: c:objc(cs)Forward@ivar1
// CHECK-NEXT:     loc:
// CHECK-NEXT:     access: public
@public
  int ivar1;
// CHECK:        - name: ivar2
// CHECK-NEXT:     USR: c:objc(cs)Forward@ivar2
// CHECK-NEXT:     loc:
// CHECK-NEXT:     access: protected
@protected
  int ivar2;
// CHECK:        - name: ivar3
// CHECK-NEXT:     USR: c:objc(cs)Forward@ivar3
// CHECK-NEXT:     loc:
// CHECK-NEXT:     access: package
@package
  int ivar3;
// CHECK:        - name: ivar4
// CHECK-NEXT:     USR: c:objc(cs)Forward@ivar4
// CHECK-NEXT:     loc:
...
// CHECK-NEXT:   superClassName:
// CHECK-NEXT:   hasExceptionAttribute: false
// CHECK-NEXT:   USR: c:objc(cs)Reverse
// CHECK-NEXT:   loc:
// CHECK-NEXT:   availability: i:0 d:0 o:0 u:0
// CHECK-NEXT:   categories:
// CHECK-NEXT:   protocols:
...
// CHECK-NEXT:     USR: c:objc(cs)Reverse@ivar4
// CHECK-NEXT:     loc:
// CHECK-NEXT:     access: private
@private
  int ivar4;
// CHECK:        - name: ivar3
// CHECK-NEXT:     USR: c:objc(cs)Reverse@ivar3
// CHECK-NEXT:     loc:
// CHECK-NEXT:     access: package
@package
  int ivar3;
// CHECK:        - name: ivar2
// CHECK-NEXT:     USR: c:objc(cs)Reverse@ivar2
// CHECK-NEXT:     loc:
// CHECK-NEXT:     access: protected
@protected
  int ivar2;
// CHECK:        - name: ivar1
// CHECK-NEXT:     USR: c:objc(cs)Reverse@ivar1
// CHECK-NEXT:     loc:
// CHECK-NEXT:     access: public
@public
  int ivar1;

...
enum Foo : NSInteger {
  ...
  // CHECK:      - name: B
  // CHECK-NEXT:   USR: c:@E@Foo@B
  // CHECK-NEXT:   loc:
  // CHECK-NEXT:   availability: i:10.9 d:0 o:0 u:0
  B __attribute__((availability(macosx, introduced = 10.9))),

  // CHECK:      - name: C
  // CHECK-NEXT:   USR: c:@E@Foo@C
  // CHECK-NEXT:   loc:
  // CHECK-NEXT:   availability: i:10.10 d:0 o:0 u:0
...
// CHECK-NEXT:     USR: c:objc(cs)Bar(im)method1
// CHECK-NEXT:     loc:
// CHECK-NEXT:     availability: i:0 d:0 o:0 u:0
- (void)method1;
...
// CHECK-NEXT:     isOptional: false
// CHECK-NEXT:     isDynamic: false
// CHECK-NEXT:     USR: c:objc(cs)Bar(im)method2
// CHECK-NEXT:     loc:
// CHECK-NEXT:     availability: i:10.10 d:0 o:0 u:0
